...
function defaultChiCho() {
  return [
    ...
    { id: 'market',    name: 'Đi chợ',    icon: 'grocery',         color: '#1B9A78', bg: '#E8F6F1' },
...
function boot() {
  ...
  const returning = isOnboardingDone();
  setTimeout(() => {
    if (returning) {
      showScreen('home');
    } else {
